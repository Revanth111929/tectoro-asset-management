...
class InventoryValidator:
    ...
    def validate_new_asset(data: Dict) -> Dict:
        ...
        # RULE 1: If Employee ID or Name exists, status MUST be 'Assigned'
        # Email and Mobile alone do not indicate assignment
        has_employee = emp_id or emp_name
        ...
        # RULE 2: If status = 'Available', Employee ID and Name MUST be empty
        # Email and Mobile can remain (orphaned contact info is acceptable)
        if status == 'Available' and has_employee:
            ...
            result['errors'].append(
                ...
                f"Please remove Employee ID and Name or change status to 'Assigned'."
            )

        # RULE 3: If status = 'Assigned', REQUIRED employee fields MUST exist
        # REQUIRED: Employee ID, Employee Name
        # OPTIONAL: Employee Email, Mobile Number
        if status == 'Assigned':
            missing_fields = []
            ...
            if missing_fields:
                ...
                result['errors'].append(
                    ...
                    f"Assigned assets must have Employee ID and Employee Name."
                )
    ...
    def validate_asset_update(asset_id: int, data: Dict) -> Dict:
        ...
        # RULE 1: If Employee ID or Name exists, status MUST be 'Assigned'
        # Email and Mobile alone do not indicate assignment
        has_employee = final_emp_id or final_emp_name
        ...
        # RULE 3: If status = 'Assigned', ONLY Employee ID and Name are required
        # Employee Email and Mobile Number are OPTIONAL
        if final_status == 'Assigned':
            ...
            # Email and Mobile are optional - do not validate
