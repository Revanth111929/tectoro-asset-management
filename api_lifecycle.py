...
def complete_temporary_assignment(assignment_id):
    ...
    try:
        ...
        # Update asset statuses - restore employee information (use what's available)
...
def create_asset_replacement():
    ...
    try:
        ...
        new_asset.employee_email = employee.email or ''  # Optional
        new_asset.mobile_number = employee.mobile_number or ''  # Optional
